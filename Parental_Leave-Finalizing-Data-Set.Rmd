...
```{r fig-7, fig.align="center", fig.cap="Distribution of Income", fig.width = 7, fig.height=6,  message=FALSE, warning=FALSE, paged.print=FALSE, echo = FALSE}
#FIGURE 7
...
# Plotly histogram  
  p <- plot_ly(alpha = 0.6) %>%
    add_histogram(x = y_income_before_preggo_ma, 
                  xbins = xbins,
                  histnorm = "percent", 
                  name = "Income before Birth Male (Parental Leave)") %>%
    add_histogram(x = y_income_before_not_preggo_ma, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income before Birth Male (No Parental Leave)") %>%
    add_histogram(x = y_income_before_preggo_fe, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income before Birth Female (Parental Leave)") %>%
    add_histogram(x = y_income_before_not_preggo_fe, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income after Birth Female (No Parental Leave)") %>%
    layout(barmode = "group", title = "Before Birth (Time Point 1)",
           xaxis = list(tickvals=seq(0, 150000, 10000),
                        title = "Income per Year"),
           yaxis = list(range = c(0, 20)),
...
# Plotly histogram  
  p <- plot_ly(alpha = 0.6) %>%
    add_histogram(x = y_income_after_preggo_ma, 
                  xbins = xbins,
                  histnorm = "percent", 
                  name = "Income after Birth Male (Parental Leave)") %>%
    add_histogram(x = y_income_after_not_preggo_ma, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income after Birth Male (No Parental Leave)") %>%
    add_histogram(x = y_income_after_preggo_fe, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income after Birth Female (Parental Leave)") %>%
