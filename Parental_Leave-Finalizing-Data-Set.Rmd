...
In the past 5 years (2015 - 2019) the number of person which receive parental allowance in Germany increased about almost 20 % from 1,561,597 to 1,865,129. The proportion of men increased by 3.5% and now accounts for almost a quarter of those receiving parental benefits. As there is a strong trend visible where more men take parental leave, there is still a discrepancy. Women stay longer in parental leave, in fact on average four times as long on as men. 
Many scientists have addressed this issue to find out whether parental leave could possibly be responsible for the gender wage gap.
*partly explained by prior decisions
The answer, there is none. There is definitely a effect of parental leave on income. That said, scholars are indecisive on why this is the case. Some argue, that the time spend in parental leave could lead to decreasing someones knowledge and skill level. Especially compared to someone which had the same level to begin with. So if they try to reenter the work force they would have to start at a lower position or just were not as far in their career than their counterparts because of the missed practice. This theory is also known as the human capital theory. On the other side, some scholars present a other possibility the signalling theory. Not only should it explain the difference between persons who been on parental leave and the ones that weren't, but also the differences between genders. As the human capital theory should have the same consequences despite the gender, the signalling theory tries to explain why there is one. Basically, taking parental leave could be seen as being less committed to the company one works with, so when it comes to promotions and so, employers might choose someone who was not in parental leave over someone that was. So some scholar claim, that this signal might be harder on men (CITE), but at the same time other argue that it is more harmful to women (CITE). 
To conclude, scholars are indecisive on what exactly causes the differences and also it is not clear if these effects have long time implications. A number of studies only researches the time frame directly or couple of years after the parental leave and also focus on the employment rate or at how fast someone will find a job again. Which is a important factor to look at, however I am more interested in the differences in income. Despite that, they are only few who looked at a rather large period of time. That said, the majority of researches are done primarily in other countries other than Germany. And as the reforms regarding parental leave are different in every country (CITE), there could be severe differences in the results. 

All in all I was wondering if the effect of human capital and the signalling theory might diminish overtime, which if this would be true might lead to more men taken part in parental leave as they might be less concerned about their career. So my question is, is there a long term effect of taking parental leave on income and does the length of the leave has a additional influence?
...
Due to the low number of observations, especially in some categories, it is not possible to match the treatment and control group resulting in a potential disadvantage. 
...
The first hypothesis I proposed was referencing to the causal influence of parental leave on income. In order to visualize the distribution of income at each time point I created a barplot shown in Figure \@ref(fig:fig-1) & \@ref(fig:fig-2). At time point 1, before the birth, both groups are centered around 20,000 to 30,000 thousand euros per year. However the treatment group has more observations in the lower half and the control group is more represented in the higher income categories, indicating that there is some prior self selection. I mentioned this in the beginning, there are lot of characteristics which goes into the decision making when it comes to taking parental leave, one of which is the income. Thus could explain why the treatment group has a overall smaller income than the control group. 
However, the second barplot displaying time point 2 shows a distinct shift of both groups. The treatment group shifted towards the lower spectrum of income and the control group in the opposite direction, leaving a greater disparity of both groups. This implies that the treatment might have a influence on income. 

To further examine this assumption I run a linear regression on basis of a difference in differences model shown in \@ref(tab2). Model 1 (M1) and Model 2 (M2) display the linear regression testing the first hypothesis. M1 only tests the influence of taking parental leave on income. The results show, that if one is taking parental leave there are likely to earn 12,399.040 Euros less after 15 years compared to someone who did not take parental leave. These results are significant within a 99% confidence interval. When introducing the control variables the results change. Taking parental leave is still significant, however the value of the coefficient decreased to -7,984.528 Euros. And even though there are less cases then before, caused by some missing values for the control variables, the adjusted r squared rose and can now can explain 20 % of the models variance.  Therefore hypothesis 1 is not rejected on a 90% confidence interval. 


```{r fig-1, fig.align="center", fig.cap="Distribution of Income", fig.width = 8, fig.height=6,  message=FALSE, warning=FALSE, paged.print=FALSE, echo = FALSE}
...
# Plotly histogram  
  p <- plot_ly(alpha = 0.6) %>%
    add_histogram(x = y_income_before_preggo, 
                  xbins = xbins,
                  histnorm = "percent", 
                  name = "Income before Birth \n(Parental Leave)") %>%
    add_histogram(x = y_income_before_not_preggo, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income before Birth \n(No Parental Leave)") %>%
    layout(barmode = "group", title = "Before Birth (Time Point 1)",font=list(size = 10))%>%
...
```{r fig-2, fig.align="center", fig.cap="Distribution of Income", fig.width = 8, fig.height=6,  message=FALSE, warning=FALSE, paged.print=FALSE, echo = FALSE}
#FIGURE 2
...
# Plotly histogram  
  p <- plot_ly(alpha = 0.6) %>%
    add_histogram(x = y_income_after_preggo, 
                  xbins = xbins,
                  histnorm = "percent", 
                  name = "Income after Birth \n(Parental Leave)") %>%
    add_histogram(x = y_income_after_not_preggo, 
                  xbins = xbins,
                  histnorm = "percent",
                  name = "Income after Birth \n(No Parental Leave)") %>%
    layout(barmode = "group", title = "After Birth (Time Point 2)",font=list(size = 10))%>%
...
Figure \@ref(fig:fig-3) & \@ref(fig:fig-4) show the distribution of income in relation to the length of the leave. As stated in hypothesis 2, I argue that the longer someone is in parental leave the higher the damage to their income. Both groups are distributed similar, they are mostly represented in the lower income field and then again around 20,000 to 30,000. Indicating, that there is less prior selection happening for both groups therefore the probability that both groups would develop in the same way over the 15 year period is higher. The second graph (Figure\@ref(fig:fig-4)) shows a difference in the development of both groups. The distribution of the treatment group generally flattened, with the majority of cases concentrated around 10,000 and 25,000. The control group, on the other hand, shows very strong variations. The percentage of those who earn up to 2500 euros per year has increased dramatically compared to the previous 15 years, just as the percentage of those who earn around 20,000 - 25,000. There is no clear implication for whether short or long parental leaves have a stronger influence on income, however the treatment group seems to have a slightly higher income overall. 
This assumption is verified by the first Model (M1) of Table \@ref(tab3) which displays only the influence of the length of the parental leave on the income difference. According to the results, by taking longer parental leave (more than 6 months), the income after 15 years after birth will be about 6,486,803 higher than for a person who has taken up to 6 months of parental leave. This result is significant within a 90 % confidence interval. With that said, the effect disappears after adding control variables to the regression. no longer suggesting a causal inference between the length of the parental leave and the annual income difference. Consequently, hypothesis 2 has to be rejected. 
...
### *Interaction between Parental Leave and Gender* {-}

Figure \@ref(fig:fig-5) & \@ref(fig:fig-6) show the distribution of income by gender and participation in parental leave. 
Important to note here is, that because of the general low number of observation, this is especially the case for certain subgroups like men taking parental leave, the results might be biased here, thus might not represent the population of Germany between 1995 to 2000 well. With that said, most of the observations for all groups group around the 20,000 to 30,000 euros per year. This is especially the case for men who take parental leave. In contrast, men who do not take parental leave are more wide spread and have a slightly higher income over all. This is mostly due to the fact, that men who earn a high income are less likely to go into parental leave in the first place (CITE). Also, there is a high number of women earning only up to 5,000 per year in this sample, especially for females who do not take parental leave. 

Looking at the second time point, 15 years later, there are some severe changes. To start with, men which did not take parental leave had a large income increase, women who did not take parental leave on the other side did increase slightly in the higher range of income, but also increased in the lower range of income.  Women who took parental leave distributed quite evenly around the 0 to 30,000 euros per year with a slight decrease towards higher income. Their male counterparts increased their income about 10,000 to 15,000 euros per year. These results imply that women compared to men will earn less overall, but also when comparing the groups which did parental leave, men seem not to be influenced. However, the number of observation for men taking parental leave is really small, so the drastic difference may be caused by that. 

In order to test the assumption, that women which had taken parental leave have a larger income decrease, I run two regressions. First, only the interaction between gender and parental leave displayed in \@ref(tab2) model 3 (M3). None of the coefficients in this model are significant. However, when adding the control variables, taking parental leave has a significant negative effect on income on a 10 % level. However, the interaction effect is still not significant, which suggests that women who take in parental leave have no additional shortcomings compared to their male counterparts regarding their income. Therefore the third hypothesis has to be rejected. 



```{r fig-5, fig.align="center", fig.cap="Distribution of Income", fig.width = 8, fig.height=6,  message=FALSE, warning=FALSE, paged.print=FALSE, echo = FALSE}
#FIGURE 5
...
```{r fig-6, fig.align="center", fig.cap="Distribution of Income", fig.width = 8, fig.height=6,  message=FALSE, warning=FALSE, paged.print=FALSE, echo = FALSE}
#FIGURE 6
...
The results give contradictory implications in regards to answering the research question whether parental leave has a negative impact on future income or not. On the one hand the results regarding hypothesis 1 are in line with prior research (Cite). There is significant evidence that parental leave has a negative impact on future income, presumably due to missed opportunities at work and the resulting decline in human capital. On the other hand, contrary to the human capital theory, I found significant results showing that a long parental leave has positive effects on the future income compared to a short leave. Therefore the results show the complete opposite of the assumption I made, namely that long parental leave would have a larger negative impact on the future income compared to stay for a short period of time in parental leave. These results could be explained by the signalling theory. Contrary to the belief of many scholars, that parental leave would signal less commitment to the company and a low work ethic in general might be true for the general impact additionally to the decrease in human capital. However, a long parental leave could be a signal for other characteristics which might be more positive. I would argue, that if someone stays longer in parental leave, that they show determination & dedication, as they leave their job to sacrifice their career to care for their child, and this especially counts when staying for a longer period of time. Additionally, it implies openness and adaptability as carrying for a new born child is a challenging task and demand constantly adaption to new situations and be open to new possibilities to do certain tasks. 
I however I did not find significant results to substantiate my third and last hypothesis. I argued that women who take parental leave have a greater disadvantage regarding their future income compared to their male counterparts. But there seems to be no interaction effect. These results are most likely due to the fact, that the number of observations is really small, especially in groups like males which take parental leave. Despite the fact that they are underrepresented in this sample, it was also just not common for men to take parental leave in the mid to end 1990s. 
...
Despite of everything, there are some major shortcomings to this study. First and foremost the number of observations is really small. Which leads to a discrimination with respect to certain characteristics. Also because of this, I was not able to do a matching process which would may have helped to control for self selection. Especially in Figure 1 time point 1, we can notice a severe difference between the control and treatment group, suggesting that there was happening some sort of self selection. Despite that, it is hard to get rid of any self selection in a natural experiment, so sometimes it is just something researcher have to deal with. Another aspect which is troubling is, that because of the low observation number it was not possible to control for working hours, which may have had an impact. And lastly there is a large number of people who started with no income (Figure 1 - 3). Their difference which was calculated on behalf of their information might have led to a bias. For example a women which got pregnant during their studies would have had no income, however 15 years later she might have a job. And due to the study design, her whole income would now be counted as increase. However, I tried to counterbalance that as I only included persons which were 21 or older, so the probability that they have a job is much higher. In addition, if all cases where someone was not employed and therefore had no income would be excluded, a lot of information would get lost (Cite someone did that to, limitations).  
...
In regards to future research, it would be good to look at these hypothesis with a larger data set, providing more suitable observations. Additionally, it would be interesting to take an even longer period of time to really examine the long term effects. For this it might be good to use more than two time points as income fluctuate quite a bit. 
Another interesting point would be to on the one hand look how the long term effects will be after the 2007 reform change and also how it compares to the 1992/1993 reform. Marie et al. (Cite), already looked at the differences between these two groups in a difference in difference model. However, they could only look at a smaller period of time. 
And lastly, the second hypothesis brings up the questions where the breaking point is regarding the length of the leave. How long has someone has to stay in parental leave to have the best possible outcome. Platenga et al. belief it should be about 6-8 months, but other scholars see it differently, taking about longer periods. But what is true, and does it hold true after the new reforms? 
