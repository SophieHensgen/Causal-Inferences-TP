...
select96 <- all96 %>%
  select(persnr, welle, pid, hhnr, cid, mp66f, d11102ll, d1110896, e1110196, l1110296, d1110796, mp10813, mp10502, isced97_96, partz96, lfs96, merwzeit, e1110196, i1111096, d1110196, w1110896) %>%
...
select97 <- all97 %>%
  select(persnr, welle, pid, hhnr, cid, np660f, d11102ll, d1110897, e1110197, l1110297, d1110797, np11513, np11202, isced97_97, partz97, lfs97, nerwzeit, e1110197, i1111097, d1110197, w1110897) %>%
...
select98 <- all98 %>%
  select(persnr, welle, pid, hhnr, cid, op5706, d11102ll, d1110898, e1110198, l1110298, d1110798, op12113, op11802, isced97_98, partz98, lfs98, oerwzeit, e1110198, i1111098, d1110198, w1110898) %>%
...
select99 <- all99 %>%
  select(persnr, welle, pid, hhnr, cid, pp7506, d11102ll, d1110899, e1110199, l1110299, d1110799, pp13320, pp13002, isced97_99, partz99, lfs99, perwzeit, e1110199, i1111099, d1110199, w1110899) %>%
...
select00 <- all00%>%
  select(persnr, welle, pid, hhnr, cid, qp7507, d11102ll, d1110800, e1110100, l1110200, d1110700, qp14220, qp13902, isced97_00, partz00, lfs00, qerwzeit, e1110100, i1111000, d1110100, w1110800) %>%
...
select01 <- all01 %>%
  select(persnr, welle, pid, hhnr, cid, rp7507, d11102ll, d1110801, e1110101, l1110201, d1110701, rp13320, rp13002, isced97_01, partz01, lfs01, rerwzeit, e1110101, i1111001, d1110101, w1110801) %>%
...
select02 <- all02 %>%
  select(persnr, welle, pid, hhnr, cid, sp7507, d11102ll, d1110802, e1110102, l1110202, d1110702, sp13320, sp13002, isced97_02, partz02, lfs02, serwzeit, e1110102, i1111002, d1110102, w1110802) %>%
...
select03 <- all03 %>%
  select(persnr, welle, pid, hhnr, cid, tp9307, d11102ll, d1110803, e1110103, l1110203, d1110703, tp14108, tp13602, isced97_03, partz03, lfs03, terwzeit, e1110103, i1111003, d1110103, w1110803) %>%
...
select04 <- all04 %>%
  select(persnr, welle, pid, hhnr, cid, up7807, d11102ll, d1110804, e1110104, l1110204, d1110704, up14408, up13902, isced97_04, partz04, lfs04, uerwzeit, e1110104, i1111004, d1110104, w1110804) %>%
...
select05 <- all05 %>%
  select(persnr, welle, pid, hhnr, cid, vp9908, d11102ll, d1110805, e1110105, l1110205, d1110705, vp15308, vp14702, isced97_05, partz05, lfs05, verwzeit, e1110105, i1111005, d1110105, w1110805) %>%
...
select06 <- all06 %>%
  select(persnr, welle, pid, hhnr, cid, wp7608, d11102ll, d1110806, e1110106, l1110206, d1110706, wp14108, wp12402, isced97_06, partz06, lfs06, werwzeit, e1110106, i1111006, d1110106, w1110806) %>%
...
select07 <- all07 %>%
  select(persnr, welle, pid, hhnr, cid, xp9308, d11102ll, d1110807, e1110107, l1110207, d1110707, xp14808, xp13102, isced97_07, partz07, lfs07, xerwzeit, e1110107, i1111007, d1110107, w1110807) %>%
...
select08 <- all08 %>%
  select(persnr, welle, pid, hhnr, cid, yp9408, d11102ll, d1110808, e1110108, l1110208, d1110708, yp15408, yp14802, isced97_08, partz08, lfs08, yerwzeit, e1110108, i1111008, d1110108, w1110808) %>%
...
select09 <- all09 %>%
  select(persnr, welle, pid, hhnr, cid, zp9008, d11102ll, d1110809, e1110109, l1110209, d1110709, zp15608, zp12902 , isced97_09, partz09, lfs09, zerwzeit, e1110109, i1111009, d1110109, w1110809) %>%
...
select10 <- all10 %>%
  select(persnr, welle, pid, hhnr, cid, bap8108, d11102ll, d1110810, e1110110, l1110210, d1110710, bap15909, bap15002, isced97_10, partz10, lfs10, baerwzeit, e1110110, i1111010, d1110110, w1110810) %>%
...
select11 <- all11 %>%
  select(persnr, welle, pid, hhnr, cid, bbp9109, d11102ll, d1110811, e1110111, l1110211, d1110711, bbp15112, bbp13202, isced97_11, partz11, lfs11, bberwzeit, e1110111, i1111011, d1110111, w1110811) %>%
...
select12 <- all12 %>%
  select(persnr, welle, pid, hhnr, cid, bcp7907, d11102ll, d1110812, e1110112, l1110212, d1110712, bcp15012, bcp12803, isced97_12, partz12, lfs12, bcerwzeit, e1110112, i1111012, d1110112, w1110812) %>%
...
select13 <- all13 %>%
  select(persnr, welle, pid, hhnr, cid, bdp9709, d11102ll, d1110813, e1110113, l1110213, d1110713, bdp15712, bdp13403, isced97_13, partz13, lfs13, bderwzeit, e1110113, i1111013, d1110113, w1110813) %>%
...
select14 <- all14 %>%
  select(persnr, welle, pid, hhnr, cid, bep8409, d11102ll, d1110814, e1110114, l1110214, d1110714, bep15012, bep12603, isced97_14, partz14, lfs14, beerwzeit, e1110114, i1111014, d1110114, w1110814) %>%
...
select15 <- all15 %>%
  select(persnr, welle, pid, hhnr, cid, bfp11808, d11102ll, d1110815, e1110115, l1110215, d1110715, bfp17312, bfpbirthy, isced97_15, partz15, lfs15, bferwzeit, e1110115, i1111015, d1110115, w1110815) %>%
...
select16 <- all16 %>%
  select(persnr, welle, pid, hhnr, cid, bgp10408, d11102ll, d1110816, e1110116, l1110216, d1110716, bgp17012, bgpbirthy, isced97_16, partz16, lfs16, bgerwzeit, e1110116, i1111016, d1110116, w1110816, bgpbirthy) %>%
...
select17 <- all17 %>%
  select(persnr, welle, pid, hhnr, cid, bhp_122_08, d11102ll, d1110817, e1110117, l1110217, d1110717, bhp_117_08, bhpbirthy,  isced97_17, partz17, lfs17, bherwzeit, e1110117, i1111017, d1110117, w1110817) %>%
...
select18 <- all18 %>%
  select(persnr, welle, pid, hhnr, cid, bip_123_08, d11102ll, d1110818, e1110118, l1110218, d1110718, bip_201_12, bipbirthy, isced97_18, partz18, lfs18, bierwzeit, e1110118, i1111018, d1110118, w1110818) %>%
